...
public abstract class SuperBaseAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
     ...
     * Animation
     */
    private AnimationType mAnimationType = AnimationType.SLIDE_FROM_RIGHT;
...
//                addAnimation(holder);
        ...
        if (null != mOnItemLongClickListener) {
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    final int position = holder.getAdapterPosition() - getHeaderViewCount() - 1;
                    if (position < 0 || position > mData.size() - 1) return true;
    ...
    public class OnItemChildClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (mChildClickListener != null) {
                int position = mViewHolder.getLayoutPosition() - getHeaderViewCount() - 1;
                mChildClickListener.onItemChildClick(SuperBaseAdapter.this, v, position, mData.get(position));
            }
        }
    }
    ...
    public interface OnRecyclerViewItemChildClickListener {
        void onItemChildClick(SuperBaseAdapter adapter, View view, int position, Object o);
    }
