...
public class EaseVoicePlayer {
    private static final String TAG = "ConcurrentMediaPlayer";

    private static EaseVoicePlayer instance = null;
    ...
    public static EaseVoicePlayer getInstance(Context context) {
        if (instance == null) {
            synchronized (EaseVoicePlayer.class) {
                if (instance == null) {
                    instance = new EaseVoicePlayer(context);
                }
            }
        }
        return instance;
    ...
    public boolean isCurrentPlayingMessage(@NonNull final EMMessage message) {
        if (playingId == null) {
            return false;
        }
        if (playingId.equals(message.getMsgId())) {
            return true;
        }
        return false;
    }
    ...
    private EaseVoicePlayer(Context cxt) {
