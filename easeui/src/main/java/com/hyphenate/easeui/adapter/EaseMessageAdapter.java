...
public class EaseMessageAdapter extends BaseAdapter{
	...
	public int getItemViewType(int position) {
		...
		if(customRowProvider != null && customRowProvider.getItemViewType(message) > 0){
		    return customRowProvider.getItemViewType(message) + 13;
		}
...
//        if(customRowProvider != null && customRowProvider.createPresenterByViewType(message, position, this) != null){
//			return customRowProvider.createPresenterByViewType(message, position, this);
//        }
